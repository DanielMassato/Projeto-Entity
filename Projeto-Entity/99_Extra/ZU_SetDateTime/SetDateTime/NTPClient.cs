			...
			get
			{
				...
				switch(Stratum)
				{
					...
					case _Stratum.PrimaryReference:
						val += NTPData[offReferenceID + 0].ToChar();
						val += NTPData[offReferenceID + 1].ToChar();
						val += NTPData[offReferenceID + 2].ToChar();
						val += NTPData[offReferenceID + 3].ToChar();
					break;
