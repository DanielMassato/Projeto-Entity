...
namespace ConsultaProdutos
{
    public partial class Form1 : Form
    {
        ...
        private void btnFiltra_Click(object sender, EventArgs e)
        {
            ...
            produtos.Command.Parameters.AddWithValue("@descricao", "%" + tbxDescricao.Text + "%");
            produtos.Command.Parameters.AddWithValue("@tipo", tbxTipo.Text + "%");
        ...
        private void btnReajusta_Click(object sender, EventArgs e)
        {
            ...
            else // selecionados
            {
                ...
                produtos.Command.CommandText = @"UPDATE PRODUTOS SET PRECO_VENDA = PRECO_VENDA * @fator
                                    WHERE ID_PRODUTO IN (" + ids + ")";
            }

            if (produtos.ExecSql() >= 0)
            {
