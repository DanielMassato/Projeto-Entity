    ...
    public partial class Form1 : Form
    {
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            var emp2 = empregados
                ...
                .Where(em => em.SALARIO < 5000)
                .OrderByDescending(em => em.SALARIO)
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            var emp2 = empregados
                ...
                .Where(em => em.SALARIO < 3000 && em.SALARIO < 6000)
                .OrderBy(em => em.SALARIO)
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            var emp = from em in empregados
                      ...
                      where em.DATA_ADMISSAO >= new DateTime(2000, 1, 1) &&
                            em.DATA_ADMISSAO <= new DateTime(2000, 12, 1)
                      orderby em.DATA_ADMISSAO
            ...
            var emp2 = empregados
                ...
                .Where(em => em.DATA_ADMISSAO >= new DateTime(2000, 1, 1) &&
                            em.DATA_ADMISSAO <= new DateTime(2000, 12, 1))
                .OrderBy(em => em.DATA_ADMISSAO)
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            var emp2 = empregados
                ...
                .Join(deptos, em => em.COD_DEPTO, d => d.COD_DEPTO,
                (em, d) => new
                {
                    em.CODFUN,
                    em.NOME,
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            var emp2 = empregados
                ...
                .Join(cargos, emd => emd.em.COD_CARGO, c => c.COD_CARGO,
                 (emd, c) => new
                 {
                     emd.em.CODFUN,
                     emd.em.NOME,
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            var emp2 = empregados
                ...
                .GroupBy(emd => emd.d.DEPTO)
                .Select(g => new 
                {
                    Departamento = g.Key,
                    TotalSalario = g.Sum(emd => emd.em.SALARIO)
                });

            tbxResult.Text = "";
            foreach (var item in emp)
                tbxResult.Text += item.Departamento + " - " +
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            var emp = from em in empregados
                      ...
                      group em by new { d.COD_DEPTO, d.DEPTO } into g                     
                      orderby g.Sum(em => em.SALARIO)
                      select new
                      {
            ...
            var emp2 = empregados
                ...
                .GroupBy(emd => new { emd.d.COD_DEPTO, emd.d.DEPTO })
                //.OrderBy(g => g.Sum(emd => emd.em.SALARIO))
                .Select(g => new
                {
                    CodDepto = g.Key.COD_DEPTO,
                    Departamento = g.Key.DEPTO,
                    TotalSalario = g.Sum(emd => emd.em.SALARIO),
                    MenorSalario = g.Min(emd => emd.em.SALARIO),
                    MaiorSalario = g.Max(emd => emd.em.SALARIO),
                    MediaSalario = g.Average(emd => emd.em.SALARIO),
                    QtdEmpregados = g.Count()
                }).OrderBy(fin => fin.TotalSalario);
            tbxResult.Text = "";
            foreach (var item in emp)
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            // Lambda
            var emp2 = empregados
                .Where (em => em.SALARIO < 8000)
                .Join(deptos, em => em.COD_DEPTO, d => d.COD_DEPTO,
                (em, d) => new { em, d })

                .GroupBy(emd => new { emd.d.COD_DEPTO, emd.d.DEPTO })

                //.Where(g => g.Sum(emd => emd.em.SALARIO) > 18000)
                ...
                .Where(fin => fin.TotalSalario > 18000)
                .OrderBy(fin => fin.TotalSalario);
            tbxResult.Text = "";
            foreach (var item in emp)
                tbxResult.Text += item.CodDepto + " - " +
        ...
        private void button11_Click(object sender, EventArgs e)
        {
            ...
            var emp2 = empregados
                ...
                .Where(em => em.NOME.StartsWith("MARIA"))
                .OrderBy(em => em.SALARIO)
